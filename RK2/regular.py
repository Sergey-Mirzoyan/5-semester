...
def FindGroups(text):
    ...
    while(1):
        ...
        match = re.match(r'(МТ|ИУ|РЛ|ФН|СМ|Э|РК|БМТ|ИБМ|Л|СГН|РКТ|АК)(10|11|12|[1-9])И?-((10|11|12|[1-9]))[1-6][бмБМ]?',
                          tmpStroke)
...
if __name__ == '__main__':
    ...
    а также не забываем ИУ7И-13 гениальных гениев из ибм12-12м, ибм13-13м,
