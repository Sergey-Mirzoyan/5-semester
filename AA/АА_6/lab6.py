...
if __name__ == "__main__":
    ...
    for i in range(int(float(citiesCount) * antFactor)):
        ant = Ant(citiesCount)
        ants.append(ant)
    alpha =0.8 #float(input("input alpha: "))
    beta = 1#int(input("input beta: "))
    evaporation =0.1 #float(input("input evaporation: "))
    Q = 100#float(input("input Q: "))
